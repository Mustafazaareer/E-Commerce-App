...
exports.addProductToCart = asyncHandler(async(req,res,next)=>{
    ...
    if (!cart) {
        ...
        if(productIndex > -1){
            ...
            // if product not exists in cart , push product to cartItem array
...
// @desc    GET current logged user cart
...
exports.removeSpecificCartItem = asyncHandler(async (req,res,next)=>{
    ...
    res
        ...
        .json({
            status:"successs",
            message:"Cart item removed successfully from your wishlist. ",
            numberOfCartItems:cart.cartItems.length,
            data:cart
    })
})
